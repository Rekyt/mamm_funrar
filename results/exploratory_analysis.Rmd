...
make_quantile_density(species_indices$Ri) +
...
make_quantile_density(species_indices$Ui) +
...
dens_di = make_quantile_density(only_di) +
...
```{r avg_di_density}
dens_avg_di = make_quantile_density(colMeans(mammal_di, na.rm = TRUE)) +
