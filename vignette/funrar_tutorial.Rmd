...
global_com = pres_mat[1,, drop = FALSE]

global_com[] = 1  # Make all species present
rownames(global_com) = "global"

global_di = distinctiveness(global_com, trait_distance)
```
...
The `funrar()` and `funrar_stack()` functions let you compute all indices at once.
